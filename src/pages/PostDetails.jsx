...
const PostDetails = () => {
  ...
  const fetchPost=async()=>{
    try{
      const res= await axios.get(URL+"/blog/v1/post/"+postId)
  ...
  const handleDeletePost=async ()=>{
    ...
    try{
      const res=await axios.delete(URL+"/blog/v1/post/"+postId,{withCredentials:true})
      console.log(res.data)
      navigate("/")
  ...
  const fetchPostComments=async()=>{
    setLoader(true)
    try{
      const res=await axios.get(URL+"/blog/v1/comment/post/"+postId)
  ...
  const postComment=async(e)=>{
    e.preventDefault()
    try{
      const res=await axios.post(URL+"/blog/v1/comment/create",
